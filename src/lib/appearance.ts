...
export interface AppearancePrefs {
  ...
  bodyFont: 'inter' | 'georgia' | 'crimson';
...
export const GOOGLE_FONTS_URL =
  'https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;1,700&family=Lora:wght@400;700&family=Merriweather:wght@400;700&family=Quicksand:wght@400;700&family=Libre+Baskerville:wght@400;700&family=Inter:wght@400;500&family=Crimson+Text:wght@400;600&display=swap';
